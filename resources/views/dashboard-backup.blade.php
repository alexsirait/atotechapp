                ...
                <div class="row vh-100 m-0 p-0">
                    ...
                    <div class="col-lg-4">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Umur</h6>
                    ...
                    <div class="col-lg-4 mt-3 mt-lg-0">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Gender</h6>
                    ...
                    <div class="col-lg-4 mt-3 mt-lg-0">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Pekerjaan</h6>
                    ...
                    <div class="col-lg-7 mt-3">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Domisili</h6>
                        ...
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <div class="d-flex gap-3 align-items-center">
                                    <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Jenis Essay</h6>
                                ...
                                <div class="p-4">
                                    <table class="table table-borderless text-center">
                                        <thead>
                                            <tr>
                                                <th class="bg-danger border-3 border-white text-white w-50">Kata</th>
                                                <th class="bg-danger border-3 border-white text-white">Jumlah Kata</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <th class="bg-danger text-white border-end" id="top1Fre">PENAMBAHAN</th>
                                                <th class="bg-danger text-white border-start" id="top1Count">14 Kata</th>
                                            </tr>
                                            <tr>
                                                <th class="bg-danger text-white border-end" id="top2Fre">KEBERSIHAN</th>
                                                <th class="bg-danger text-white border-start" id="top2Count">11 Kata</th>
                                            </tr>
                                            <tr>
                                                <th class="bg-danger text-white border-end" id="top3Fre">AC</th>
                                                <th class="bg-danger text-white border-start" id="top3Count">7 Kata</th>
                                            </tr>
                                            <tr>
                                                <th class="bg-danger text-white border-end" id="top4Fre">RAME</th>
                                                <th class="bg-danger text-white border-start" id="top4Count">6 Kata</th>
                                            </tr>
                                            <tr>
                                                <th class="bg-danger text-white border-end" id="top5Fre">RAME</th>
                                                <th class="bg-danger text-white border-start" id="top5Count">6 Kata</th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <div class="d-flex gap-3 align-items-center">
                                    <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Jenis Opsi</h6>
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="card h-100 rounded-4 border-0 shadow-sm">
                            <div class="card-body">
                                <h6 class="px-3 py-2 rounded-1 text-white d-inline-block" style="background-color: #FC307B;">Jenis Check Box</h6>
